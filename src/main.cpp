...
const string strMessageMagic = "SOLAR Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SOLAR", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1504255202, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        assert(block.hashMerkleRoot == uint256("0xf2a207cd1373ebdd49ce602caa94957893ae0eacdb7d0446715bf2bf02c2057e"));
